...
class MCQ(FlaskForm):
    ...
    power = RadioField("Do you desire a higher social status and dominance over others? (4", choices=[(4, 'It is my utmost priority'), (3, 'It is my priority'), (2, 'Medium'), (1, 'It is not my priority')])
