...
class MCQ(FlaskForm):
    ...
    power = TextAreaField("Is power important to you? Defining goal: social status and prestige, control or dominance over people and resources.", [DataRequired(), Length(max=)])