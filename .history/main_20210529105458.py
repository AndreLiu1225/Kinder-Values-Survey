...
def data_dashboard():
    ...
    stimulation = request.form.get('power')
    hedonism = request.form.get('power')
    conformity = request.form.get('power')
    self_direction = request.form.get('power')
    benevolence = request.form.get('power')
    universalism = request.form.get('power')
