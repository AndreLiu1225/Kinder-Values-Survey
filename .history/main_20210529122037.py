...
class Survey(db.Model):
    ...
    achievement = db.Column(db.Integer, nullabl)
    stimulation = db.Column(db.Integer, nullabl)
    hedonism = db.Column(db.Integer, nullabl)
    conformity = db.Column(db.Integer, nullabl)
    security = db.Column(db.Integer, nullabl)
