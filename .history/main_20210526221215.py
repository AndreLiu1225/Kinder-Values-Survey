...
class MCQ(FlaskForm):
    ...
    power = IntegerField("Do you desire a higher social status and dominance over others? (4- It is my utmost priority, 3-It is important, 2-Doesn't bother me, 1-Not even a thought)",         return redirect(url_for('data_dashboard'))
)
