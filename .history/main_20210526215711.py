...
class MCQ(FlaskForm):
    ...
    stimulation = IntegerField("Do you prefer novel and exciting challenges in life?")
    hedonism = IntegerField("Is personal gratification the most important?")
    conformity = IntegerField("Do you think restraint of actions against social norms is important?")
    self_direction = IntegerField("Do you think independent thought and action are important")
