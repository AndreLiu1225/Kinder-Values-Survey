...
def data_dashboard():
    form=MCQ()
    power = MCQ(request.form.get('power', False))
    tradition = MCQ(request.form.get('tradition', False))
    achievement = MCQ(request.form.get('achievement', False))
    stimulation = MCQ(request.form.get('stimulation', False))
    hedonism = MCQ(request.form.get('hedonism', False))
    conformity = MCQ(request.form.get('conformity', False))
    security = MCQ(request.form.get('security', False))
    self_direction = MCQ(request.form.get('self_direction', False))
    benevolence = MCQ(request.form.get('benevolence', False))
    universalism = MCQ(request.form.get('universalism', False))
