...
def values_quiz():
    ...
    if form.validate_on_submit():
        ...
        post = Survey(age=form.age.data, name=form.name.data, profession=form.profession.data, power=)
        return redirect(url_for('data_dashboard'))
    else:
        flash('Survey is incomplete. Please check that you have answered all of the questions.', 'danger')
