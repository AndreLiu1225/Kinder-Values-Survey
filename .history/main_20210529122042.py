...
class Survey(db.Model):
    ...
    age = db.Column(db.Integer, nullabl)
    email = db.Column(db.String(50), uniqu, nullable)
    profession = db.Column(db.String(50), nullable)
    power = db.Column(db.Integer, nullable)
    tradition = db.Column(db.Integer, nullable)
    achievement = db.Column(db.Integer, nullable)
    stimulation = db.Column(db.Integer, nullable)
    hedonism = db.Column(db.Integer, nullable)
    conformity = db.Column(db.Integer, nullable)
    security = db.Column(db.Integer, nullable)
    self_direction = db.Column(db.Integer, nullabl)
    benevolence = db.Column(db.Integer, nullabl)
    universalism = db.Column(db.Integer, nullabl)
    date_posted = db.Column(db.DateTime, nullabl, default=datetime.datetime.utcnow)
