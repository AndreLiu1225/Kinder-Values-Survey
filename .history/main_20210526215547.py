...
class MCQ(FlaskForm):
    ...
    tradition = IntegerField("Do you care about preserving traditions", choices=[(4, 'It is my utmost priority'), (3, 'It is my priority'), (2, 'Medium'), (1, 'It is not my priority')])
    achievement = IntegerField("Is achievement according to social standards important?", choices=[(4, 'It is my utmost priority'), (3, 'It is my priority'), (2, 'Medium'), (1, 'It is not my priority')])
    stimulation = IntegerField("Do you prefer novel and exciting challenges in life?", choices=[(4, 'It is my utmost priority'), (3, 'It is my priority'), (2, 'Medium'), (1, 'It is not my priority')])
    hedonism = IntegerField("Is personal gratification the most important?", choices=[(4, 'It is my utmost priority'), (3, 'It is my priority'), (2, 'Medium'), (1, 'It is not my priority')])
    conformity = IntegerField("Do you think restraint of actions against social norms is important?", choices=[(4, 'It is my utmost priority'), (3, 'It is my priority'), (2, 'Medium'), (1, 'It is not my priority')])
    self_direction = IntegerField("Do you think independent thought and action are important", choices=[(4, 'It is my utmost priority'), (3, 'It is my priority'), (2, 'Medium'), (1, 'It is not my priority')])
